...
## classe zero (disco voador)
class Rex_0(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.disco_voador = pygame.image.load("C:\\Users\\Jordane AS\\Pictures\\codigos malucos\\amogus_voador\\4.png")

        self.frame_count = 0
        self.frame_rate = 5
        self.atual = 0
        self.image_voadora = self.disco_voador
...
class Rex_1(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.sprites = [
            pygame.image.load("C:\\Users\\Jordane AS\\Pictures\\codigos malucos\\amogus_voador\\1.png"),
            pygame.image.load("C:\\Users\\Jordane AS\\Pictures\\codigos malucos\\amogus_voador\\2.png"),
            pygame.image.load("C:\\Users\\Jordane AS\\Pictures\\codigos malucos\\amogus_voador\\3.png")
        ]
...
class Pulando(pygame.sprite.Sprite):
    def som_do_pulo():
        som_salto = pygame.mixer.Sound("C:\\Users\\Jordane AS\\Pictures\\codigos malucos\\amogus_voador\\smw_jump.wav")
        som_salto.play()

    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.sprites = []
        self.sprites.append(pygame.image.load("C:\\Users\\Jordane AS\\Pictures\\codigos malucos\\amogus_voador\\1.png"))
        self.atual = 0
        self.image = self.sprites[self.atual]
        self.image = pygame.transform.scale(self.image, (tamanho, tamanho))
...
while True:
    ...
    pygame.display.set_caption("Amogus Voador - Dinossauro do Chrome") 
    ...
    if jogando:
        ...
        # Defina o retângulo do jogador
        jogador_rect = pygame.Rect(jogador_x, jogador_y, tamanho, tamanho)

        # Defina os retângulos dos obstáculos

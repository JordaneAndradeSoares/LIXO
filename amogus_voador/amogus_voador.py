...
class Rex_1(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.sprites = [
            pygame.image.load("C:\\Users\\Jordane AS\\OneDrive\\Imagens\\codigos malucos\\amogus_voador\\1.png"),
            pygame.image.load("C:\\Users\\Jordane AS\\OneDrive\\Imagens\\codigos malucos\\amogus_voador\\2.png"),
            pygame.image.load("C:\\Users\\Jordane AS\\OneDrive\\Imagens\\codigos malucos\\amogus_voador\\3.png")
        ]
...
# primeira classe (inimigo voador)
class Rex_0(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.disco_voador = pygame.image.load("C:\\Users\\Jordane AS\\OneDrive\\Imagens\\codigos malucos\\amogus_voador\\4.png")
...
# segunda classe (inimigo que anda)
...
# terceira classe (pulo)
class Pulando(pygame.sprite.Sprite):
    def som_do_pulo():
        som_salto = pygame.mixer.Sound("C:\\Users\\Jordane AS\\OneDrive\\Imagens\\codigos malucos\\amogus_voador\\smw_jump.wav")
        som_salto.play()

    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.sprites = []
        self.sprites.append(pygame.image.load("C:\\Users\\Jordane AS\\OneDrive\\Imagens\\codigos malucos\\amogus_voador\\1.png"))
        self.atual = 0
        self.image = self.sprites[self.atual]
        self.image = pygame.transform.scale(self.image, (tamanho, tamanho))
